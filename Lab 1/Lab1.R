...
simtab <- table(c(rep("Windows",80),rep("OSX",12),rep("linux",4),rep("other",4)))
barplot(simtab)
simtab2 <- simtab/sum(simtab)
barplot(simtab2)
...
#rbinom(number of possible outcomes, number of trials, probability)
throw15 <- rbinom(6, 15000, 1/6)
barplot(throw15)
